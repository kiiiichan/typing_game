...
//関数６．判定処理  
 ...
 // let input = player_type.value;
  ...
  let startButtonOn = () => {
    document.getElementById('start_button').style.backgroundColor = "#DD372A";
    document.getElementById('start_button').style.borderColor = "#DD372A";
    document.getElementById('start_button').style.color = "#ffffff";
  };
